...
// rest of your code
    $.ajax({
         type: "POST",
         url: "content/transaksi/counter.php",
         success: function (response) {
             $(".counter").show();
             $("#loader").hide();
             $(".counter").load("respon/respon_transaksi.php",1);
...
// rest of your code
        $.ajax({
             type: "POST",
             url: "content/transaksi/back.php",
             success: function (response) {
                 $(".counter").show();
                 $("#loader").hide();
                 $(".counter").load("respon/respon_transaksi.php",1);
...
<div class="modal fade" id="confirm-restart" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="content/transaksi/restart.php" class="btn btn-danger danger">Yes</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="confirm-restart-print" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="print/restart_transaksi.php" class="btn btn-danger danger">Yes</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="confirm-jump" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form  id="formNextAccountSettings" class="form-condensed" action="content/transaksi/jump.php" method="POST">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
