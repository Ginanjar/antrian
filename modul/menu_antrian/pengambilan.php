...
if ($_SESSION[leveluser]=='admin' OR $_SESSION[leveluser]=='loket pas' ){
...
?>
            ...
            <div class="well well-black">
                ...
                <div class="section-title">
                    <center><h4 style="font-weight:bold; color:gray;"><i class=" fontello-icon-docs"></i> Loket PENGAMBILAN </h4></center>
                </div>
                <div class="row-fluid">
                        <div class="span4">
...
// rest of your code
    $.ajax({
         type: "POST",
         url: "content/pengambilan/counter.php",
         success: function (response) {
             $(".counter").show();
             $("#loader").hide();
             $(".counter").load("respon/respon_pengambilan.php",1);
...
// rest of your code
        $.ajax({
             type: "POST",
             url: "content/pengambilan/back.php",
             success: function (response) {
                 $(".counter").show();
                 $("#loader").hide();
                 $(".counter").load("respon/respon_pengambilan.php",1);
...
<div class="modal fade" id="confirm-restart" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="content/pengambilan/restart.php" class="btn btn-danger danger">Yes</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="confirm-restart-print" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="print/restart_pengambilan.php" class="btn btn-danger danger">Yes</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="confirm-jump" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form  id="formNextAccountSettings" class="form-condensed" action="content/pengambilan/jump.php" method="POST">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
